...
@dataclass
class GetPositionForPortfolioInstrumentRequest:
    portfolio: str
    instrument: str
...
@dataclass
class GetPositionForPortfolioInstrumentResponse(BaseResponse):
...
class IntxClient:
    ...
    def get_position_for_portfolio_instrument(
            self, request: GetPositionForPortfolioInstrumentRequest
        ...
        return GetPositionForPortfolioInstrumentResponse(response.json(), request)
